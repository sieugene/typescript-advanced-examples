...
type CurrencyValue = number | string | CurrencyPrototype;
...
interface CurrencyPrototype {
  intValue: number;
  value: number;
  _settings: CurrencyOptions & Defaults;
  _precision: number;
  add(n: number): CurrencyPrototype;
  subtract(n: number): CurrencyPrototype;
  multiply(n: number): CurrencyPrototype;
  divide(n: number): CurrencyPrototype;
  distribute(n: number): CurrencyValue[];
  dollars(): number;
  cents(): number;
...
interface CurrencyConstructor {
  new (value: CurrencyValue, opts: CurrencyOptions): CurrencyPrototype;
  (value: CurrencyValue, opts: CurrencyOptions): CurrencyPrototype;
...
function parse(
  ...
  if (isNumber || value instanceof currency) {
    v = (value instanceof currency ? value.value : +value) * precision;
...
currency.prototype = {
  ...
  // intValue, value, _settings, _precision
  /**
